"""
Data Models & Telemetry Definitions for CardioMRI-Strain: Feature Tracking & Global Longitudinal Strain Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "SCMR Recommended CMR Protocols 2020"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
