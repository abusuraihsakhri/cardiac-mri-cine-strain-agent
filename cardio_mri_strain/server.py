"""
FastAPI REST API Server for CardioMRI-Strain: Feature Tracking & Global Longitudinal Strain Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="CardioMRI-Strain: Feature Tracking & Global Longitudinal Strain Agent",
            description="Tracks myocardial endocardial/epicardial contours across cine cardiac MRI cycles, computing Global Longitudinal Strain (GLS).",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "cardiac-mri-cine-strain-agent", "domain": "Cardiology AI", "version": "2.0.0-FRONTIER"}
